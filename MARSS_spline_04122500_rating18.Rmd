...
Zt <- t(predict( gam21_model, newdata = data.frame( stage_discrete_mea = df_stage_flow_allDays$stage_daily_mean),
                                           type = 'lpmatrix') )
# Remove row names
rownames(Zt) <- NULL
...
kem_fit_a <- MARSS(Yt, model = model.gen, control = list(maxit = 1000),inits = coef(kem_fit_f))
kem_fit_b <- MARSS(Yt, model = model.gen, control = list(maxit = 1000),inits = coef(kem_fit_a))
kem_fit_c <- MARSS(Yt, model = model.gen, control = list(maxit = 1000),inits = coef(kem_fit_b))
kem_fit_d <- MARSS(Yt, model = model.gen, control = list(maxit = 1000),inits = coef(kem_fit_c))
kem_fit_e <- MARSS(Yt, model = model.gen, control = list(maxit = 1000),inits = coef(kem_fit_d))
kem_fit_f <- MARSS(Yt, model = model.gen, control = list(maxit = 1000),inits = coef(kem_fit_e))
...
kem_fit_a <- MARSS(Yt, model = model.gen, control = list(maxit = 1000))
