...
gam18_model <- gam( flow_discrete_mea ~ s(stage_discrete_mea, bs = 'cr'), 
...
Zt <- t(predict( gam21_model, newdata = data.frame( stage_discrete_mea = df_stage_flow_allDays$stage_mean_day),
                                           type = 'lpmatrix') )
# Remove row names
rownames(Zt) <- NULL
