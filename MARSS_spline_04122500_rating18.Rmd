...
#   Rename column rated_flow_18 to rated_flow_init
...
```{r, fig.height = 24 , eval = FALSE, echo = FALSE}
...
tmp_df %>% 
  dplyr::filter( waterYear %in% c( 1990, 1995, 2000, 2005, 2010, 2015, 2019) ) %>%
  ...
  ylab( 'Stage, in feet above gage datum' ) + 
  labs(title = 'Stage-Flow Ratings at 04122500 Pere Marquette River at Scottville, MI') +
  geom_line( data = rating18, aes( x = rated_flow_18, y = stage, group = NULL), color = 'red', size = 1 ) +
