...
Qdiag <- c(paste0('q*', format(gam18_model$Vp[1,1], digits = 6)),
           paste0('q*', format(gam18_model$Vp[2,2], digits = 6)),
           paste0('q*', format(gam18_model$Vp[3,3], digits = 6)),
           paste0('q*', format(gam18_model$Vp[4,4], digits = 6)),
           paste0('q*', format(gam18_model$Vp[5,5], digits = 6)))
