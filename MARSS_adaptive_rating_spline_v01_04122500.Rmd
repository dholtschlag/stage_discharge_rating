...
table( discrete_meas$control_type, discrete_meas$qualifier ) %>%
  kable( digits = 4, 
         caption = paste0('Table ', table_no, ',. Frequency of flow measurements by control type and measurement qualifiers at ',
...
gam_parameters[,10] <- gamPOA_rating$coefficients
...
gam_parameters_df %>% 
  ...
  pack_rows('Generalized Additive Models based on discrete measurement data', 1, 5) %>% 
  pack_rows('Generalized Additive Models estimated from stage-flow rating data', 6, 10 )
...
On some days during the period of analysis, multiple discrete measurements were made at `r station_no` 
