...
df_stage_flow_allDays[, ] %>% 
  ...
  geom_point( size = 1 ) +
  # geom_vline( xintercept = df_stage_flow_allDays$Date[ ndx_miss ], color = 'blue') + 
...
Figure `r fig_no + 1 ` shows the close correpondence  between discrete stage on days of field measurements and daily mean stage computed from unit values.  Only one estimated stage was inconsistent with the computed mean.  
